...
/// In my solution I dont need the "document.getElementById" but would need to identify it them as "sayHelloButton"
...
sayHelloButton.addEventListener('mouseout', revertColorChange)
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/devmountain')
    .then(response => {
        console.log(response.data);
...
/*
    ...
    Inside the repeatMyParam function above, grab the element with the id of 'repeat-text' and set its textContent property equal to the response data. Set 'repeat-text' textcontent property equal to the response data.
*/
